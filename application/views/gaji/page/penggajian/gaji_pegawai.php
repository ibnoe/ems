<div class = "oneTwo">
<br /><?php echo anchor('gaji/add_penggajian', img(array('src'=>'images/icons/control/32/plus.png','border'=>'0','alt'=>'ADD')), 'title="ADD"' ); ?>

	<div class="widget">
            <div class="title"><img src="<?php echo base_url()?>images/icons/dark/pencil.png" alt="" class="titleIcon" /><h6>Lihat Gaji Pegawai</h6></div>
			<?php
			$attributes = array('class'=>'form');
			echo form_open('gaji/view_penggajian_list', $attributes);
			?>
