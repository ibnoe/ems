...
<title>Gapura Cargo</title>
	...
	<script type="text/javascript" src="<?php echo base_url() ?>wp-content/themes/ems/js/swfobject.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>wp-content/themes/ems/js/jquery.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>wp-content/themes/ems/js/jquery.lightbox-0.5.js"></script>
