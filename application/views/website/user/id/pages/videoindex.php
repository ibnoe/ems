				...
				<div class="roundedBox">
					...
					{ ?>
						...
						foreach ($konten as $row_gallery) :
						{
							...
							<?php echo anchor($row_gallery['permalink'],img(array('src'=>"wp-content/uploads/2012/thumb/".$row_gallery['alt'], 'alt'=>$row_gallery['title'])), array('class'=>"fancybox-effects-d", 'title'=>$row_gallery['title'])); ?><br /><?php echo anchor($row_gallery['filename'],$row_gallery['filename']); ?>
							</td>
						<?php }
							else
							{ ?>
